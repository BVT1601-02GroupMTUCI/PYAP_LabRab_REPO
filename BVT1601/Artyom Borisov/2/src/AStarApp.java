...
public class AStarApp {
    ...
    private void initGUI()
    {
        ...
        mapCells[startLoc.x_Coord][startLoc.y_Coord].setEndpoint(true);
        mapCells[finishLoc.x_Coord][finishLoc.y_Coord].setEndpoint(true);
    }
    ...
    private void findAndShowPath()
    {
        ...
        while (wp != null)
        {
            ...
            mapCells[loc.x_Coord][loc.y_Coord].setPath(true);
