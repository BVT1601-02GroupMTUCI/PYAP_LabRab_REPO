...
public class FractalExplorer {
	...
	public void createAndShowGUI ()  // создание визуала и вывод его на экран
	{
		...
		JButton button = new JButton("—брос");
	...
	private class Zoom extends MouseAdapter{     //класс считывает действие мыши(клик) и пересчитывает область дл€ отрисовки фрактала
		@Override
